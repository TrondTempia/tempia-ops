...
export default function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Temporary simplified auth without Supabase
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="din.epost@tempia.no"
                    required
                    disabled={isLoading}
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 px-4 rounded-md font-medium transition-colors focus:outline-none shadow-card disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    backgroundColor: 'var(--color-login-button)',
