...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-card border-b border-border shadow-card sticky top-0 z-40">
        ...
        <div className="border-t border-border px-6">
          <nav className="flex space-x-8">
            ...
            <a href="#" className="border-b-2 border-transparent py-4 px-1 text-muted-foreground hover:text-foreground">
              Hendelser
            </a>
            <a href="#" className="border-b-2 border-transparent py-4 px-1 text-muted-foreground hover:text-foreground">
              Ressurser
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 bg-card border-r border-border transition-transform duration-200 ease-in-out`}>
          <div className="flex flex-col h-full">
            <div className="p-6">
              <div style={{ fontSize: 'var(--text-h3)', fontWeight: 'var(--font-weight-semibold)', color: 'var(--color-text-primary)' }}>
                Navigasjon
              </div>
            </div>
            
            <nav className="flex-1 px-4 space-y-2">
              <NavItem icon={<Home />} active>Oversikt</NavItem>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-3 space-y-6">
              <Card title="Aktive Prosedyrer">
                <div className="space-y-4">
                  <div className="p-4 bg-muted border border-border" style={{ borderRadius: 'var(--radius-component-md)' }}>
                    <div className="flex items-start justify-between mb-2">
                      <div style={{ fontSize: 'var(--text-body)', fontWeight: 'var(--font-weight-semibold)' }}>
                        Brannalarm - Bygning A
                      </div>
                      <Badge variant="warning" style="solid">Aktiv</Badge>
                    </div>
                  ...
                  <div className="p-4 bg-muted border border-border" style={{ borderRadius: 'var(--radius-component-md)' }}>
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <Badge variant="error" style="solid">Kritisk</Badge>
                    </div>
                    <p className="text-muted-foreground mb-3" style={{ fontSize: 'var(--text-small)' }}>
            ...
            <div className="lg:col-span-6 space-y-6">
              <Card title="Systemstatus Oversikt">
                <div className="h-96">
                  <div className="w-full h-full bg-muted border-2 border-dashed border-border flex items-center justify-center" style={{ borderRadius: 'var(--radius-component-lg)' }}>
                    <div className="text-center text-muted-foreground">
                      ...
                      <div style={{ fontSize: 'var(--text-small)' }}>
                        Her vil systemstatus-diagram vises
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card>
                  <div className="text-center">
                    <div style={{ fontSize: 'var(--text-h1)', fontWeight: 'var(--font-weight-bold)', color: 'var(--color-state-success)' }}>
                      89
                    </div>
                    <div className="text-muted-foreground" style={{ fontSize: 'var(--text-small)' }}>
                ...
                <Card>
                  <div className="text-center">
                    <div style={{ fontSize: 'var(--text-h1)', fontWeight: 'var(--font-weight-bold)', color: 'var(--color-state-warning)' }}>
                      3
                    </div>
                    <div className="text-muted-foreground" style={{ fontSize: 'var(--text-small)' }}>
                      Varsler aktive
              ...
              <Card title="Systemstatus">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="success" style="subtle">Online</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span style={{ fontSize: 'var(--text-small)' }}>GPS Tracking</span>
                    <Badge variant="success" style="subtle">Aktiv</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span style={{ fontSize: 'var(--text-small)' }}>Backup Systemer</span>
                    <Badge variant="warning" style="subtle">Standby</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span style={{ fontSize: 'var(--text-small)' }}>Ekstern API</span>
                    <Badge variant="error" style="subtle">Offline</Badge>
                  </div>
                </div>
              </Card>
            </div>
